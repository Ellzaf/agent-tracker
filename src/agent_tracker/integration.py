...
from agent_tracker.constants import SCHEMA_VERSION, SUPPORTED_EVENT_TYPES
from agent_tracker.serialization import utc_now_iso
...
@dataclass(frozen=True, slots=True)
class AgentTrackerIntegrationReport:
    project: str
...
def emit_integration_report(
    ...
    *,
    ...
    payload = {
        "run_type": "agent_tracker_integration_report",
