"""Adapter for Ellzaf reference-code artifact rows."""
...
class AdapterError(AgentTrackerError):
...
class AitradeExporter:
    ...
    def __init__(
        ...
        *,
        ...
        self._clients: dict[str, AgentTracker] = {}
    ...
    def fetch_rows(
        ...
        try:
            ...
            raise AdapterError(
                "Install agent-tracker[aitrade] to export from Postgres"
            ) from exc
    ...
    def _client(self, environment: str) -> AgentTracker:
